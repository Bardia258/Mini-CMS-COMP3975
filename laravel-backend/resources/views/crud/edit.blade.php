...
@section('content')
    <div class="container mt-5">
        ...
        <form action="{{ route('crud.update', $article['id']) }}" method="POST" class="card p-4">
            @csrf
            @method('PUT')
    ...
    <script>
        ...
        // Load article content from the data attribute
        ...
        // Also load old content if form was resubmitted with errors
